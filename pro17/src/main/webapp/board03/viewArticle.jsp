...
<script type="text/javascript">
	...
	function fn_modify_article(obj) {
		obj.action="${contextPath}/board4/modArticle.do";
		obj.submit();
	}
		...
		<table border=0 align="center">
			...
			<tr id="tr_btn">
				<td colspan="2" align="center">
					...
					<input type="button" value="삭제하기" onClick="fn_remove_article('${contextPath}/board4/removeArticle.do',${article.articleNO})">
					<input type="button" value="리스트로 돌아가기" onClick="backToList(this.form)">
					<input type="button" value="답글쓰기" onClick="fn_reply_form('${contextPath}/board4/replyForm.do',${article.articleNO })">
