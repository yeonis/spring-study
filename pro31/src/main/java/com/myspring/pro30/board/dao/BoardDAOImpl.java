...
public class BoardDAOImpl implements BoardDAO {
		...
		public List selectAllArticlesList() throws DataAccessException{
			List<ImageVO> articlesList = articlesList = sqlSession.selectList("mapper.board.selectAllArticlesList");
			return articlesList;
		}
		 ...
		 * (ArrayList)articleeMap.get("imageFileList"); int articleNO =
		 * (Integer)articleMap.get("articleNO"); int imageFileNO =
		 * selectNewImage.get("articleNO"); for(ImageVO imageVO : imageFileList) {
